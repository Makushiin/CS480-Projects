 ...
 */
void report_request_removed(ConsumerType consumer, RequestType type,
 ...
 */
void report_production_history(unsigned int produced[], unsigned int consumed[][RequestTypeN]);
